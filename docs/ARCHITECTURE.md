...
wechat-agent-bridge is split into transport, durable coordination, agent adapters, and local safety/storage layers. WeChat protocol data does not become agent-session state, and Codex/Claude-specific event formats do not leak into the durable inbox.
